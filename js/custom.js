...
/* LTR version Start */
$(document).on("click", "#myonoffswitch190", function (e) {
  e.preventDefault();
  $("body").addClass("ltr");
  ...
  document
    ...
    .setAttribute("href", "plugins/bootstrap/css/bootstrap.min.css");
...
/* RTL version Start */
$(document).on("click", "#myonoffswitch200", function (e) {
  e.preventDefault();
  $("body").addClass("rtl");
  ...
  document
    .getElementById("style")
    .setAttribute("href", "plugins/bootstrap/css/bootstrap.rtl.min.css");
  var carousel = $(".owl-carousel");
  $.each(carousel, function (index, element) {
    // element == this
    var carouselData = $(element).data("owl.carousel");
