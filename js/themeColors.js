...
function names() {
	...
	if (document.querySelector('#percentchart') !== null) {
		percentchart();
	}

	if (document.querySelector('#full_progress_chart') !== null) {
		full_progress_chart();
	}

	if (document.querySelector('#circle_progress_chart') !== null) {
		circle_progress_chart();
	}

	if (document.querySelector('#user_chart') !== null) {
		user_chart();
	}
	...
	if (document.querySelector('#order_status_1') !== null) {
		order_status_1();
	}

	if (document.querySelector('#order_status_2') !== null) {
		order_status_2();
	}

	if (document.querySelector('#order_status_3') !== null) {
		order_status_3();
	}

	if (document.querySelector('#order_status_4') !== null) {
		order_status_4();
	}
